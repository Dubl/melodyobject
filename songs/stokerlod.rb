...
stopp=Section.new
stopp.addon(intro.uf,wdrums.uf,dintro.uf,wdrums.uf,intro.uf)
=end

stopp=l_load('vaaqrb',2)
=begin
stopp.versionize(4)
stopp.alter_versions_all(:alter_pitch,'Alter_Pitch_Paramobj',5)
