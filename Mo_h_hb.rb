...
def starting?
 if @started then
 false unless @children[@currentchild].offset==Midistack.ticker
 else
...
def ending?
 if Midistack.ticker==@children[@currentchild].offset+@children[@currentchild].space then
  @children[@currentchild].started=false
  true
 end
end
